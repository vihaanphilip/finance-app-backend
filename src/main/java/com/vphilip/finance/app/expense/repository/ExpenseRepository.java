...
public interface ExpenseRepository extends JpaRepository<Expense, Long> {
    ...
    @Query(value = """
            ...
            ORDER BY e.id DESC
            """, nativeQuery = true)
    List<ExpenseDTO> findAllByBudgetId(@Param("budgetId") Long budgetId, @Param("userId") Integer userId);

    @Modifying
    @Query(value = "UPDATE expense SET budget_id = NULL WHERE budget_id = :budgetId", nativeQuery = true)
